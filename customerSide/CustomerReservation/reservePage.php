...
<body>
    <?php
        ...
        if ($reservationStatus === 'success') {
            ...
            '<h1 class="text-center" style="font-family: Copperplate; color: whitesmoke;">VJTI Canteen</h1>' .
                    ...
                    <form id="reservation-form" method="POST" action="insertReservation.php">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="table_id" id="table_id_reserve" style="width:10em;" required>
                                ...
                                $select_query_tables = "SELECT * Restaurant_Tables WHERE capacity >= '$head_count'";
